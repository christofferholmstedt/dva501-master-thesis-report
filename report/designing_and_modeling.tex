...
The design even makes it possible for a subnet manager to be responsible for
multiple subnets on different types of link-layers even if it's not supported
by the SPA standards.
...
The actual design of the Communication package make use of the "Composite
